...
require (
	...
	github.com/nutanix/ntnx-api-golang-clients/clustermgmt-go-client/v4 v4.3.1 // indirect
	...
	github.com/nutanix/ntnx-api-golang-clients/vmm-go-client/v4 v4.3.1 // indirect
